...
站点同时提供三条「云游路线」和仅保存在浏览器本地的足迹记录、结构化项目案例、星渊 Attention 互动实验、笔记显式引路／回望关系。它们都复用现有七境叙事和内容数据，不要求登录或额外后端。
...
已实现：七地全境地图、同构四时场景、可分享的地点深链、键盘可访问卷轴侧栏、无脚本地名册、区域内容集合、云游路线与本地足迹、七境生活工具、全站随手记、重复任务、离线工作台、雨桥嵌入式云镜、星渊成长路线与 Attention 实验、全站中文搜索、笔记筛选与双向连接、结构化项目案例、公开履历、RSS、Sitemap、自定义 404、响应式导航和减少动态效果支持。
