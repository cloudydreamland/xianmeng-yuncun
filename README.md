...
站点同时提供三条「云游路线」和仅保存在浏览器本地的足迹记录、结构化项目案例、星渊 Attention 互动实验、笔记显式引路／回望关系，以及自动汇总计划与近期内容的 `/now` 页面。它们都复用现有七境叙事和内容数据，不要求登录或额外后端。

站点也将日常工具分别安放在七境：云村展示今日概览，雨桥收纳全站随手记，星渊提供专注计时，风谷承接阅读，月潭管理任务、重复清单、生活期限、极简账目和物品位置，雪崖记录习惯，灯巷保存生活手记。顶部“生活”菜单统一通往这些功能，手机安装为 PWA 后还可从系统分享面板直接把链接送入雨桥。
...
已实现：七地全境地图、同构四时场景、可分享的地点深链、键盘可访问卷轴侧栏、无脚本地名册、区域内容集合、云游路线与本地足迹、七境生活工具、全站随手记、重复任务、离线工作台、雨桥嵌入式云镜、星渊成长路线与 Attention 实验、全站中文搜索、笔记筛选与双向连接、结构化项目案例、公开履历、近期动态、RSS、Sitemap、自定义 404、响应式导航和减少动态效果支持。
