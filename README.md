...
已实现：可点击云村地图、四幅独立昼夜场景、全站时间主题、像素精灵地点窗、全站中文搜索、可分享的笔记分类与标签筛选、阅读进度、目录定位、代码复制、项目详情与封面、可视化内容后台、关于页、RSS、Sitemap、自定义 404、响应式导航、云幕入场和减少动态效果支持。

暂未实现：云灵桌宠、天气系统、实际环境音资源、评论，以及 Sveltia 尚未提供的 Editorial Workflow。
