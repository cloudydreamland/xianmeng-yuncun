...
export const lifeModules: LifeModule[] = [
  ...
  { id: 'inbox', label: '收集', title: '灵念收集箱', description: '任务、链接与未分类念头的统一入口', realm: 'rain-bridge', realmLabel: '雨桥', href: '/world/rain-bridge/#inbox', mark: '收' },
  { id: 'focus', label: '专注', title: '星渊定时', description: '专注计时与当日专注记录', realm: 'star-abyss', realmLabel: '星渊', href: '/world/star-abyss/#focus', mark: '定' },
  { id: 'reading', label: '阅读', title: '待阅笺匣', description: '站内文章与外部链接的阅读队列', realm: 'wind-valley', realmLabel: '风谷', href: '/world/wind-valley/#wind-notes-title', mark: '阅' },
