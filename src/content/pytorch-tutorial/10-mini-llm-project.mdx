...
用自己的话解释“把文本变成 next-token 训练样本”，并能独立运行、修改本节代码。先关注数据的形状与流向，再记接口名称。
...
用自己的话解释“搭建最小 Decoder-only Language Model”，并能独立运行、修改本节代码。先关注数据的形状与流向，再记接口名称。
...
用自己的话解释“训练、验证与过拟合一个小批次”，并能独立运行、修改本节代码。先关注数据的形状与流向，再记接口名称。
...
用自己的话解释“自回归生成、温度与 top-k”，并能独立运行、修改本节代码。先关注数据的形状与流向，再记接口名称。
...
<details className="lesson-answer">
  <summary>查看参考答案与验收点</summary>
  <p>参考答案的关键不是抄固定输出，而是按本节“运行结果与观察”逐项断言。完成后用一句话解释“自回归生成、温度与 top-k”改变了哪一个数据流或训练状态。</p>
</details>
...
用自己的话解释“KV Cache 为什么能加速解码”，并能独立运行、修改本节代码。先关注数据的形状与流向，再记接口名称。
...
<details className="lesson-answer">
  <summary>查看参考答案与验收点</summary>
  <p>参考答案的关键不是抄固定输出，而是按本节“运行结果与观察”逐项断言。完成后用一句话解释“KV Cache 为什么能加速解码”改变了哪一个数据流或训练状态。</p>
</details>
...
用自己的话解释“用 LoRA 思想做参数高效微调”，并能独立运行、修改本节代码。先关注数据的形状与流向，再记接口名称。
...
用自己的话解释“把项目整理成算法岗可讲述的证据”，并能独立运行、修改本节代码。先关注数据的形状与流向，再记接口名称。
...
<details className="lesson-answer">
  <summary>查看参考答案与验收点</summary>
  <p>参考答案的关键不是抄固定输出，而是按本节“运行结果与观察”逐项断言。完成后用一句话解释“把项目整理成算法岗可讲述的证据”改变了哪一个数据流或训练状态。</p>
</details>
