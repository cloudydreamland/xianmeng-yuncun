...
- 排查“初始化如何影响信号与梯度”时只看最终 loss，没有保存梯度范数、学习率、AMP 状态或 NaN/Inf 出现位置。
...
<details className="lesson-answer">
  <summary>查看参考答案与验收点</summary>
  <p>验收：监控项足以复现并定位异常，并能说明“AMP：autocast 与 GradScaler 分工”影响稳定性的具体路径。</p>
</details>
...
<details className="lesson-answer">
  <summary>查看参考答案与验收点</summary>
  <p>验收：监控项足以复现并定位异常，并能说明“系统定位 NaN 与 Inf”影响稳定性的具体路径。</p>
</details>
...
- 排查“最小可复现实验与训练监控”时只看最终 loss，没有保存梯度范数、学习率、AMP 状态或 NaN/Inf 出现位置。
